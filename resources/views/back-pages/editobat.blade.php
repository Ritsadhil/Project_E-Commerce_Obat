...
<!-- UBAH body class dari "min-h-screen flex items-center justify-center p-8" -->
<body class="h-screen flex items-center justify-center p-4">
    
    <!-- UBAH div class dari "max-w-5xl w-full p-12" -->
    <div class="gradient-card rounded-3xl shadow-2xl w-[90%] h-[92vh] p-6 flex flex-col overflow-hidden">
        ...
        <form action="/obat/{{ $obat->id }}" method="POST" enctype="multipart/form-data" id="obatForm" class="flex-1 flex flex-col overflow-hidden">
            ...
            <div class="grid grid-cols-2 gap-6 flex-1 overflow-hidden">
                ...
                <div class="flex flex-col items-center justify-center">
                    ...
                    <div class="image-placeholder rounded-2xl w-64 h-64 flex items-center justify-center mb-4 overflow-hidden" id="imagePreviewBox">
                        @if($obat->gambar)
                        <img id="imagePreview" class="w-full h-full object-cover" src="{{ asset('images/products/' . $obat->gambar) }}" alt="">
                        @else
