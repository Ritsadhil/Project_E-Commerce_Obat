        ...
        <div class="w-[90%] mx-auto flex items-center justify-between">
            ...
            <div class="flex items-center gap-3">
                ...
                <span class="text-white text-[50px] font-extrabold leading-none tracking-[0.4px]
                 ...
                 <div class="text-white text-[50px] font-extrabold leading-none tracking-[0.4px]
                            [text-shadow:-1px_-1px_0_#00B7B5,1px_-1px_0_#00B7B5,-1px_1px_0_#00B7B5,1px_1px_0_#00B7B5]">Dashboard</div> 
            </div>
           
            {{-- NAV RIGHT --}}
           <div class="flex items-center gap-3">
            <span class="font-semibold">Admin</span>
            <div class="w-10 h-10 bg-gray-300 rounded-full flex items-center justify-center text-[#004d40]">
...
<div class="flex flex-1 overflow-hidden">
        ...
        <aside class="w-64 bg-gray-100 border-r border-gray-200 flex flex-col py-8 overflow-y-auto">
            <nav class="space-y-4 px-4">
                
                <a href="{{ route('obat.index') }}" 
   class="{{ request()->routeIs('obat.index') ? 'bg-[#00897b] text-white shadow-md' : 'text-black hover:bg-gray-200' }} 
    ...
    Obat
        ...
        <main class="flex-1 overflow-y-auto p-8 bg-[#f5f5f5]">
            @yield('content')
        </main>
    </div>
